...
const char *CLIENT_ID = "led01";         //客户端ID
const char *USERNAME="lin01";
const char *PASSWORD="123456";
const char *PUBLISH_TOPIC = "sub01";    //发布的topic
const char *SUBSCRIBE_TOPIC = "pub01";  //订阅的topic
...
void setup() {
    ...
    Serial.println("AugPAKE Certifying......");
    Serial.println("AugPAKE SUCCESS!");
